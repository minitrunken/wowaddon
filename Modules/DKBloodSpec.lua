...
local abilities = {
    ...
    ["OutBreak"] = { spellId = 77575, color = { r = 0.8, g = 0.1, b = 0.8 }, priority = 3, condition = function()
        local target = "target"
        return UnitExists(target) and not HasFrostFever(target) and not HasBloodPlague(target) and IsAbilityUsable(77575)
    end },
    ["Mind Freeze"] = { spellId = 47528, color = { r = 1, g = 0, b = 0 }, priority = 4, condition = function()
        local target = "target"
    ...
    ["Rune Tap"] = { spellId = 48982, color = { r = 0, g = 1, b = 0 }, priority = 5, condition = function()
        local target = "target"
    ...
    ["Icebound Fortitude"] = { spellId = 48792, color = { r = 0, g = 0, b = 1 }, priority = 6, condition = function()
        local target = "target"
        return UnitExists(target) and UnitHealth("player") / UnitHealthMax("player") < 0.30 and IsAbilityUsable(48792)
    end },
    ["Vampiric Blood"] = { spellId = 55233, color = { r = 0.5, g = 0, b = 0.5 }, priority = 7, condition = function()
        local target = "target"
        return UnitExists(target) and UnitHealth("player") / UnitHealthMax("player") < 0.25 and IsAbilityUsable(55233)
    end },
    ["Raise Dead"] = { spellId = 46584, color = { r = 1, g = 1, b = 0 }, priority = 8, condition = function()
        local target = "target"
